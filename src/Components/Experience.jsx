  ...
  return (
    <div className="p-10 md:p-20 flex flex-col items-center justify-center" id="Experience">
      <div className="container mx-auto px-4 md:px-16 lg:px-24">
        <h2
          data-aos="fade-down"
          className="text-center text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-semibold mb-10 md:mb-20 leading-normal uppercase bg-gradient-to-r text-transparent bg-clip-text from-white to bg-purple-600 break-words"
        >
          Experience
        </h2>
